...
```{r setup}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("~/Coding in R/week 2")) 
```
...
```{R}
EnhancedVolcano(sigs.df, x='log2FoldChange', y='padj', lab=rownames(sigs.df), col=c('black', 'pink','purple','red'))+coord_flip()
```